...
CREATE INDEX idx_route_boardings_session_id ON route_boardings(session_id);
CREATE INDEX idx_route_boardings_route_id ON route_boardings(route_id);
CREATE INDEX idx_route_boardings_boarding_time ON route_boardings(boarding_time);
CREATE INDEX idx_route_boardings_session_alighting_time ON route_boardings(session_id, alighting_time);
